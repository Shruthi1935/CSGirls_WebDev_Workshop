...
export default function PortfolioPage() {
    return (
      ...
      <div className="flex flex-col space-y-8"> 
        <div className="font-sugarmagic text-8xl text-black px-24 pt-20 pb-5"> Inventory Tracking System </div>
        <div className="flex flex-row space-x-12 mx-24">
            <a href="https://github.com/Shruthi1935/Inventory-Tracking-System" target="_blank"> 
                <img src="inventory2.png" alt="Description" className="h-150 w-250 ml-auto rounded-md cursor-pointer hover:scale-101 duration-400"/>
            </a>
